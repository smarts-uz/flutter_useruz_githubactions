class FavoriteTasksModel {
  ...
  factory FavoriteTasksModel.fromJson(Map<String, dynamic> json) {
    int lastPage = 0;
    int total = 0;
    try {
    ...
    return FavoriteTasksModel(
      data: json["data"] == null
          ? <TaskModelResult>[]
          : List<TaskModelResult>.from(
              json["data"].map((x) => TaskModelResult.fromJson(x['task']))),
      lastPage: lastPage,
      total: total,
    );
  }
