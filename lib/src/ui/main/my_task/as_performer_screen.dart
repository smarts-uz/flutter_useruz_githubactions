...
class AsPerformerScreen extends StatefulWidget {
  const AsPerformerScreen({super.key, required this.performer});
  final int performer;

  @override
  State<AsPerformerScreen> createState() => _AsPerformerScreenState();
}

class _AsPerformerScreenState extends State<AsPerformerScreen> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: myTaskAsPerformerBloc.allCount,
