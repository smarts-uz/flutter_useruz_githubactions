...
class FilterSubCategoryScreen extends StatefulWidget {
  final String title;
  final int id;
  ...
  @override
  State<FilterSubCategoryScreen> createState() =>
      _FilterSubCategoryScreenState();
}

class _FilterSubCategoryScreenState extends State<FilterSubCategoryScreen> {
